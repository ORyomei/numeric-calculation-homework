...
from init_prob import l1, l2, m2, mu, g, theta12Initial, theta12_DInitial, tDelta, logEveryT
from numpy import cos, float64, matrix, ndarray, power, sin, zeros, block, eye
...
nc.setDataFileName("data_controled.csv")
